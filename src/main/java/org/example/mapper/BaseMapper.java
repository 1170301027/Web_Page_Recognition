...
import org.example.mybatis.CrudTemplet;
...
public interface BaseMapper {
     ...
     * </p>
     *
     * 通用的数据库插入操作，主键自增，插入后id在obj.getId()里
     *
     * @param obj pojo对象
     * @return int 数据库更新的行数
     */
    ...
    /**
     * 通用的数据库删除操作，通过条件删除，慎用--验证字段不为空，防止多删
     *
     * @param obj pojo对象
     * @return int 数据库更新的行数
     */
